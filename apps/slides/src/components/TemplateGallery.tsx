...
const templates = [
  { id: 'blank', name: 'Blank Document', icon: FileText, color: 'text-slate-200', bg: 'bg-slate-700' },
  { id: 'resume', name: 'Modern Resume', icon: User, color: 'text-blue-400', bg: 'bg-blue-900/20' },
  { id: 'letter', name: 'Cover Letter', icon: File, color: 'text-green-400', bg: 'bg-green-900/20' },
  { id: 'invoice', name: 'Professional Invoice', icon: CreditCard, color: 'text-purple-400', bg: 'bg-purple-900/20' },
  { id: 'project', name: 'Project Proposal', icon: Layout, color: 'text-orange-400', bg: 'bg-orange-900/20' },
  { id: 'newsletter', name: 'Newsletter', icon: FileImage, color: 'text-pink-400', bg: 'bg-pink-900/20' },
  { id: 'notes', name: 'Meeting Notes', icon: Calendar, color: 'text-red-400', bg: 'bg-red-900/20' },
  { id: 'brochure', name: 'Product Brochure', icon: LayoutTemplate, color: 'text-cyan-400', bg: 'bg-cyan-900/20' },
];
      ...
      <div className="bg-[#1e293b] border border-slate-700 rounded-2xl shadow-2xl w-full max-w-4xl max-h-[85vh] flex flex-col overflow-hidden">
        ...
        <div className="p-6 border-b border-slate-700 flex items-center justify-between bg-slate-800/50">
          <div>
            ...
            <p className="text-sm text-slate-400">Start your document with a professional layout</p>
          </div>
          <button 
            onClick={onClose}
