            ...
            switch (action.value) {
                case 'attachFile':
                    ...
                    break;
                          ...
                          const signature = `<br><br>--<br>Regards,`;
    ...
    return (
        <div className="bg-rose-50 border-t border-slate-200 p-4">
            ...
            <div className="text-sm text-slate-600 mb-4 space-y-2">
                {/* From: field intentionally omitted to avoid displaying any name or email */}
...
const EmailDetail = ({ thread, onMarkAsUnread, onMoveToSpam, onMoveToTrash }: EmailDetailProps) => {
    ...
    const handleReplyAll = () => {
        const myEmail = ""; // intentionally blank to avoid exposing an email address
