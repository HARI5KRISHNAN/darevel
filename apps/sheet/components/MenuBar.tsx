        ...
        return (
          <button
            ...
            className={`
              ...
              ${isActive 
                ? 'bg-white dark:bg-[#0f172a] text-green-700 dark:text-green-400 border-slate-200 dark:border-slate-700 border-b-transparent relative z-10 translate-y-[1px]' 
