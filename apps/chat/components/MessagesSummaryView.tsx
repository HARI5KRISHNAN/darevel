...
const MessagesSummaryView: React.FC<MessagesSummaryViewProps> = ({
  ...
  React.useEffect(() => {
    try {
      ...
      devError("Failed to load saved selections:", err);
    }
  }, []);
  ...
  React.useEffect(() => {
    try {
      ...
      devError("Failed to save selections:", err);
    }
  }, [selectedMessageIds]);
  ...
  const handleGenerateSummary = async () => {
    try {
      ...
      devError("Error generating summary:", err);
  ...
  const handleDownloadPDF = () => {
    ...
    try {
      ...
      devError("Failed to generate PDF:", err);
