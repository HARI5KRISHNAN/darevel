...
export const useWebRTCCall = ({ user, onIncomingCall, sendSignal }: UseWebRTCCallProps) => {
    ...
    const initializePeerConnection = useCallback((receiver: User, channelId: string) => {
        ...
        // Simplified configuration - sometimes less is more
    ...
    const startCall = useCallback(async (
        ...
        try {
            ...
            // Simple approach: just add tracks directly (no transceivers)
            ...
            try {
                console.log('🎬 Creating offer...');
                console.log('🎬 sendSignal available?', !!sendSignal);
                console.log('🎬 user available?', !!user);
                console.log('🎬 About to call createOffer()...');
                
                // Try with explicit offer options - seems to work better in some browsers
